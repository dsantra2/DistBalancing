...
This supplementary file contains replication codes for "Distributional Balancing for Causal Inference: A Unified Framework via Characteristic Function Distance" (https://doi.org/10.48550/arXiv.2601.15449)[^1].
...
$$
\tau_{\text{LATE}}^{*} = E\big( Y _i(A_i=1) - Y _ i ( A _ i=0 ) \mid A _ i ( Z _ i=1) > A_ i(Z _i=0) \big) = \frac{E\{(2Z_i-1)Y_i/\Pr(Z_i|X_i)\}}{E\{(2Z_i-1)A_i/\Pr(Z_i|X_i)\}}
$$
